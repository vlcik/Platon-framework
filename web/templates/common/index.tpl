				...
				<div>
                                    ...
                                    <form id="registracia" action="index.php?mode=common&module=auth&action=register" method="post">
                                        <table>
                                            <tr>
                                                <td><b>Meno:</b></td>
                                                <td><input id="name" type="text" name="meno" value="{php}if (isset($_POST['meno'])) echo $_POST['meno'];{/php}"/></td>

                                            </tr>
                                            <tr>
                                                <td><b>Priezvisko:</b></td>
                                                <td><input type="text" name="priezvisko" value="{php}if (isset($_POST['priezvisko'])) echo $_POST['priezvisko'];{/php}"/></td>
                                            </tr>
                                            <tr>
                                                <td><b>Pohlavie:</b></td>
